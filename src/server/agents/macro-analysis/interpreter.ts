...
Respond with ONLY a single JSON object, no markdown code fences, no prose before or after, matching exactly this shape:
{
  ...
  "positiveFactors": [ { "factor": string, "whatIsHappening": string, "whyItMattersToCompany": string, "effect": "positive", "significance": "low"|"medium"|"high", "timeHorizon": "short_term"|"medium_term"|"long_term" } ],
  "negativeFactors": [ same shape as positiveFactors but "effect": "negative" ],

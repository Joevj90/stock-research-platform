...
Respond with ONLY a single JSON object, no markdown code fences, no prose before or after, matching exactly this shape:
{
  ...
  "whatManagementIsDoingWell": [ { "factor": "short label", "explanation": "plain-language explanation grounded in the real data given" } ],
  "managementConcerns": [ { "factor": "short label", "explanation": "plain-language explanation grounded in the real data given" } ],
